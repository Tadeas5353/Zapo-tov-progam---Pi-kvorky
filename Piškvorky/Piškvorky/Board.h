	...
	policko tah_bota()
	{
		...
		case 3:
			...
			if (k_vyhre != 3)
			{
				...
				{
					zkusebni_plocha = pseudoplocha(plocha, width, heigth, i->souradnice_x - 65, i->souradnice_y, symbol_pocitace);
					lze_vyhrat = zkontroluj_vyhru(zkusebni_plocha, i->souradnice_x - 65, i->souradnice_y, k_vyhre - 1, width, heigth);
					if (lze_vyhrat)
					{
						policko nove = nove_policko(i->souradnice_x, i->souradnice_y);
						for (k = 0; k < 300; ++k)
				...
				for (auto i = policka.begin(); i != policka.end();)
				{
					souper_muze_vyhrat = false;
					zkusebni_plocha = pseudoplocha(plocha, width, heigth, i->souradnice_x - 65, i->souradnice_y, symbol_hrace);
					souper_muze_vyhrat = zkontroluj_vyhru(zkusebni_plocha, i->souradnice_x - 65, i->souradnice_y, k_vyhre - 1, width, heigth);
					if (souper_muze_vyhrat)
					{
						policko nove = nove_policko(i->souradnice_x, i->souradnice_y);
						for (k = 0; k < 100; ++k)
				...
				if (k_vyhre == 5)
				{
					...
					{
						zkusebni_plocha = pseudoplocha(plocha, width, heigth, i->souradnice_x - 65, i->souradnice_y, symbol_pocitace);
						lze_vyhrat = zkontroluj_vyhru(zkusebni_plocha, i->souradnice_x - 65, i->souradnice_y, 3, width, heigth);
						if (lze_vyhrat)
						{
							policko nove = nove_policko(i->souradnice_x, i->souradnice_y);
							for (k = 0; k < 30; ++k)
					...
					for (auto i = policka.begin(); i != policka.end();)
					{
						souper_muze_vyhrat = false;
						zkusebni_plocha = pseudoplocha(plocha, width, heigth, i->souradnice_x - 65, i->souradnice_y, symbol_hrace);
						souper_muze_vyhrat = zkontroluj_vyhru(zkusebni_plocha, i->souradnice_x - 65, i->souradnice_y, 3, width, heigth);
						if (souper_muze_vyhrat)
						{
							policko nove = nove_policko(i->souradnice_x, i->souradnice_y);
							for (k = 0; k < 15; ++k)
